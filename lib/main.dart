...
import 'screens/user_account.dart'; // Import the UserAccountsPage
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/profilecard': (context) => ProfileCardPage(user: ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>),
